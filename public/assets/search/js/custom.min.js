...
var Tixia = function () {
	...
	const form = document.getElementById('wizardFormPleaseWork');
	form.addEventListener('submit', handleFormSubmitting)


	function handleFormSubmitting(e) {
		$.ajax({
			type: 'POST',
			url: 'http://localhost:3000/',
			data: $('#wizardFormPleaseWork').serialize(),
			cache: false,
			success: function () {
				alert("we did it")
			...
			error: function () {
				...
				$('#smartwizard').smartWizard("goToStep", 0);
				$('#wizardFormPleaseWork').trigger("reset");
			}
	...
	var btnFinish = $('<button id="finishing" ></button>').text('Finish')
		.addClass('btn btn-info sw-btn-finish disabled')


	var handleSmartWizard = function () {
		$("#smartwizard").on("showStep", function (e, anchorObject, stepNumber, stepDirection, stepPosition) {
			if (stepPosition === 'last') {
				$("#finishing").removeClass('disabled');
